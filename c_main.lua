...
local label = guiCreateLabel( 0, 0, screenX, 15, "ArabNight RP v2.1", false )
...
addEventHandler('onClientGUIClick', label, function()
	local url = "https://discord.gg/cnYhk3W97d"
	--triggerEvent('debug:releases', localPlayer)
	setClipboard(url)
	outputChatBox("[ArabNight-System] إلى الحافظة! '".. url .. "' تم النسخ", 255,255,255)
end, false)
